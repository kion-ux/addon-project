...
| **ギア3** | 命中 60 回 | 0.35/秒 | 4 | 技中だけ前腕・拳が膨張し、斧は脛も膨らむ。常時は通常の輪郭を保つ。 |
...
- **変身していない間だけ**回復します: 1.2/秒、戦闘していない時間が
  続くと 2.4/秒。**変身中は回復せず、維持コストだけが減り続けます**
  （気力が尽きると自動で解除されます）
...
| **負荷テスト区画** | 同時戦闘時の重さを測る | 人数と敵数を固定できる配置（標的20体ぶん・プレイヤー4人ぶんの目印） |
...
| ギア2 | 156 | 22 | 512x512 |
| ギア3 | 159 | 22 | 512x512 |
| ギア4・バウンドマン | 161 | 22 | 1024x512 |
| ギア4・スネイクマン | 169 | 22 | 512x512 |
| ギア5・ニカ | 173 | 28 | 1024x512 |
